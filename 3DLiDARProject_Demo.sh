...
# Localization
gnome-terminal -t "Localization" -x bash -c 'source ~/3dlidar_ws/devel/setup.bash;roslaunch hdl_graph_slam AGV_hdl_graph_navigation.launch'
sleep 1
...
# Realsense Up
gnome-terminal -t "Realsense" -x bash -c 'source ~/common_ws/devel/setup.bash;roslaunch realsense2_camera LiDAR_1xD455.launch'
sleep 1
